...
更多实现细节，请参考 [`MemoryStorage`](https://github.com/keq-request/keq-cache/blob/main/src/storage/memory-storage/memory-storage.ts) 和 [`IndexedDBStorage`](https://github.com/keq-request/keq-cache/blob/main/src/storage/indexed-db-storage/indexed-db-storage.ts) 的源代码。
