...
export default function CodeExample(): ReactNode {
  return (
    <div className="relative">
      {/* 发光效果 */}
      <div className="absolute -inset-4 bg-gradient-to-r from-orange-400 to-yellow-400 rounded-3xl opacity-20 blur-2xl"></div>

      <div className="relative bg-white dark:bg-gradient-to-br dark:from-slate-900 dark:to-slate-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-slate-700">
        {/* 窗口标题栏 */}
